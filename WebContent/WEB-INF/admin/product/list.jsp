								...
								<tr
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="page.currentPage != 1">
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?currentPage=1">首页</a> |
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?currentPage=<s:property value="page.currentPage-1"/>">上一页</a> |
										</s:if>
										<s:if test="page.currentPage != page.totalPages">
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?currentPage=<s:property value="page.currentPage+1"/>">下一页</a> |
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?currentPage=<s:property value="page.totalPages"/>">尾页</a>
										</s:if>
									</td>
