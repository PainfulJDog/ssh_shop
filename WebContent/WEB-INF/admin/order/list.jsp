					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="order" value="page.list">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="page.currentPage != 1">
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?currentPage=1">首页</a> |
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?currentPage=<s:property value="page.currentPage-1"/>">上一页</a> |
										</s:if>
										<s:if test="page.currentPage != page.totalPages">
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?currentPage=<s:property value="page.currentPage+1"/>">下一页</a> |
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?currentPage=<s:property value="page.totalPages"/>">尾页</a>
										</s:if>
									</td>
