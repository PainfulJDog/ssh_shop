...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery_002.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery_004.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery_003.js"></script>
		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" href="http://image/r___________renleipic_01/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg" rel="gallery">
						...
						</div><div style="width: 0%; height: 0px;" class="zoomWrapperImage">
...
<%-- 						<img src="${pageContext.request.contextPath}/resources/image/r___________renleipic_01/bigPic139f030b-d68b-41dd-be6d-b94cc568d3c5.jpg"> --%>
					</div>
				</div>
