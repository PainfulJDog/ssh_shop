					...
					<form id="loginForm" action="${pageContext.request.contextPath}/user_login.action" method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20"><s:fielderror fieldName="username"></s:fielderror>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off"><s:fielderror fieldName="password"></s:fielderror>
								</td>
							</tr>
								<tr>
									<th>
							...
							<tr>
								...
								<td>
									<input type="submit" class="submit" value="登 录"><font color="red"><s:actionerror /></font>
								</td>
							</tr>
							<tr class="register">
								<th>&nbsp;
