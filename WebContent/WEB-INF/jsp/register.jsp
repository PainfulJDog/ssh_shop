...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/mine/checkFormjQuery.js"></script>
...
// 		}
// 		// 3.打开连接:
// 		xhr.open("GET","${pageContext.request.contextPath}/user_checkUsername.action?timestamp="+new Date().getTime()+"&username="+username,true);
// 		// 4.发送
// 		xhr.send(null);
// 	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_register.action"  method="post" novalidate="novalidate" onsubmit="return checkFormByjQuery();">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password" id="repassword" name="repassword" class="text" maxlength="20" autocomplete="off"><span><s:fielderror fieldName="password"></s:fielderror></span>
								</td>
							</tr>
							<tr>
								<th>
