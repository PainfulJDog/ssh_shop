...
<div class="container cart">
		<div class="span24">
			<s:if test="#session.cart==null || #session.cart.cartItemsFromMap.size()==0">
			...
			<s:else>
				...
				<table>
					<tbody><tr>
						...
						<s:iterator value="#session.cart.cartItemsFromMap">
							<tr>
								<td width="60">
								...
								<td>
									<a href="${pageContext.request.contextPath}/cart_removeFromCart.action?pid=<s:property value="product.pid "/>" class="delete">删除</a>
								</td>
							</tr>
						</s:iterator>
				</tbody></table>
